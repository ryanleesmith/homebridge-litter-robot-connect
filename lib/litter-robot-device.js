...
class LitterRobotDevice {
    ...
    setNightlightService(service) {
        ...
        let value = device.getNightlight();
        this.nightlightService.getCharacteristic(platform.Characteristic.On).updateValue(value);
    }
    ...
    setOccupancyService(service) {
        ...
        let value = device.getOccupancy();
        this.occupancyService.getCharacteristic(platform.Characteristic.OccupancyDetected).updateValue(value);
        this.occupancyService.getCharacteristic(platform.Characteristic.StatusActive).updateValue(true);
        this.occupancyService.getCharacteristic(platform.Characteristic.StatusFault).updateValue(false);
    }

    async sync() {
        this.platform.log('Syncing robot: ' + this.id);
